...
Matrix4 Matrix4::SetupRotationX(float theta)
{
	Matrix4 result(1.f, 0.f, 0.f, 0.f,
...
Matrix4 Matrix4::SetupRotationY(float theta)
{
	Matrix4 result(cos(theta), 0.f, sin(theta), 0.f,
				   0.f, 1.f, 0.f, 0.f,
...
Matrix4 Matrix4::SetupRotationZ(float theta)
{
	Matrix4 result(cos(theta), -sin(theta),0.f, 0.f,
...
Matrix4 Matrix4::RotationMatrix(float xRotation, float yRotation, float zRotation)
{
	Matrix4 resultX = *this * SetupRotationX(xRotation);
	Matrix4 resultY = *this * SetupRotationY(yRotation);
	Matrix4 resultZ = *this * SetupRotationZ(zRotation);
	Matrix4 result = resultX * resultY * resultZ;
	return result;
}
