...
std::ostream& operator<<(std::ostream& out, const Vector4& a_RHS)
{
...
Vector4 Vector4::HexaColor(unsigned int hexa)
{
	Vector4 RGBA(0xff & hexa >> 24, 0xff & hexa >> 16, 0xff & hexa >> 8, 0xff & hexa);
	return RGBA;
}